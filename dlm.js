...
//---------------------- 自定义变量区域 -----------------------------------
const giftName = {
    "001": '一等奖 免费摩洛哥风情浓溢几头肉手拍披萨券',
    "002": '二等奖 半价金臻滋享松板肉手拍披萨券',
    "003": '三等奖 免费xxx烤牛肉串券',
    "004": '四等奖 免费任意口味一对烤翅券',
    "005": "五等奖 免费香甜菠萝芝士派券",
}
...
class UserInfo {
    ...
    async gameDone() {
        try {
            const options = {
                //签到任务调用签到接口
                url: `https://game.dominos.com.cn/gold/game/gameDone`,
                //请求头, 所有接口通用
    ...
    async sharingDone() {
        try {
            const options = {
                //签到任务调用签到接口
                url: `https://game.dominos.com.cn/gold/game/sharingDone`,
                //请求头, 所有接口通用
                headers: this.headers,
    ...
    async point() {
        try {
            const options = {
                //签到任务调用签到接口
                url: `https://game.dominos.com.cn/gold/game/myPrize?${this.openid}`,
                //请求头, 所有接口通用
                headers: this.headers,
            };
            //post方法
